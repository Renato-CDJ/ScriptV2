  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-white via-orange-50/20 to-amber-50/20 dark:from-zinc-900 dark:to-zinc-950 p-4 md:p-6 relative overflow-hidden">
        {/* Simplified static background elements for better performance */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-orange-400/5 dark:bg-orange-500/5 rounded-full blur-2xl"></div>
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-amber-400/5 dark:bg-amber-500/5 rounded-full blur-2xl"></div>
        </div>
