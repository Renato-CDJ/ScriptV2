...
-- Em producao, habilite e configure policies adequadas
-- ============================================================
...
-- Criar policies permissivas (caso RLS seja habilitado depois)
DO $$
DECLARE
  tables_rls TEXT[] := ARRAY['users', 'operators', 'quality_posts', 'quality_comments', 'admin_questions', 'feedbacks', 'presentations', 'contracts', 'quality_questions'];
  tbl TEXT;
BEGIN
  FOREACH tbl IN ARRAY tables_rls
  LOOP
    BEGIN
